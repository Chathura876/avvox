 ...
 <script type="text/javascript">
    ...
    $(document).ready(function () {
      ...
      $('#PeopleTableContainer').jtable({
        ...
        actions: {
          listAction: 'process/operators.inc.php?action=list',
          createAction: 'process/operators.inc.php?action=create',
          updateAction: 'process/operators.inc.php?action=update',
          deleteAction: 'process/operators.inc.php?action=delete'
        },
