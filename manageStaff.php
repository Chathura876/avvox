 ...
 <script type="text/javascript">
    ...
    $(document).ready(function () {
      ...
      $('#PeopleTableContainer').jtable({
        ...
        actions: {
          listAction: 'process/staff.inc.php?action=list',
          createAction: 'process/staff.inc.php?action=create',
          updateAction: 'process/staff.inc.php?action=update',
          deleteAction: 'process/staff.inc.php?action=delete'
        },
        ...
        fields: {
          ...
          usertype: {
            title: 'User Type',
            options: {'admin': 'Admin','director': 'Director','dealer': 'Dealer', 'salesrep': 'Sales Rep','technician': 'Technician', 'storeskeeper': 'Stores Keeper', 'accountant': 'Accountant', 'operator': 'Operator'},
            edit: true
          },                   
           username: {
            list: false,
           ...
           password: {
            ...
            create: true
              ...
              formCreated: function (event, data) {
                  ...
                  data.form.find('input[name="usertype"]').addClass('validate[required]');
