 ...
 <script type="text/javascript">
    ...
    $(document).ready(function () {
      ...
      $('#PeopleTableContainer').jtable({
        ...
        actions: {
          listAction: 'process/salesreps.inc.php?action=list',
          createAction: 'process/salesreps.inc.php?action=create',
          updateAction: 'process/salesreps.inc.php?action=update',
          deleteAction: 'process/salesreps.inc.php?action=delete'
        },
