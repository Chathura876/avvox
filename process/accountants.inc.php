...
try
{
	...
	if($_GET["action"] == "list")
	{
		...
		$query = "SELECT id, fullname, nic, address, phone1, phone2, email FROM user WHERE usertype='accountant'";
	...
	{ 
		...
		$result = mysqli_query($mysqli, "INSERT INTO `user` (username, password, fullname, nic, address, phone1, phone2, email, usertype, role_id) VALUES ('$username', '$password', '$fullname', '$nic', '$address', '$phone1', '$phone2', '$email', 'accountant',7)");
