...
try
{
	...
	if($_GET["action"] == "list")
	{
		...
		$query = "SELECT id, fullname, nic, address, phone1, phone2, email FROM user WHERE usertype='storeskeeper'";
	...
	{ 
		...
		$result = mysqli_query($mysqli, "INSERT INTO `user` (username, password, fullname, nic, address, phone1, phone2, email, usertype, role_id) VALUES ('$username', '$password', '$fullname', '$nic', '$address', '$phone1', '$phone2', '$email', 'storeskeeper',6)");
