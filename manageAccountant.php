 ...
 <script type="text/javascript">
    ...
    $(document).ready(function () {
      ...
      $('#PeopleTableContainer').jtable({
        ...
        actions: {
          listAction: 'process/accountants.inc.php?action=list',
          createAction: 'process/accountants.inc.php?action=create',
          updateAction: 'process/accountants.inc.php?action=update',
          deleteAction: 'process/accountants.inc.php?action=delete'
        },
