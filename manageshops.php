...
<?php
$permissions = array("admin", "salesrep", "dealer","director");
 ...
 <script type="text/javascript">
    ...
    $(document).ready(function () {
      ...
      $('#PeopleTableContainer').jtable({
        ...
        actions: {
          listAction: 'process/shops.inc.php?action=list',
          createAction: 'process/shops.inc.php?action=create',
          updateAction: 'process/shops.inc.php?action=update',
          deleteAction: 'process/shops.inc.php?action=delete'
        },
