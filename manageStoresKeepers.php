 ...
 <script type="text/javascript">
    ...
    $(document).ready(function () {
      ...
      $('#PeopleTableContainer').jtable({
        ...
        actions: {
          listAction: 'process/storeskeepers.inc.php?action=list',
          createAction: 'process/storeskeepers.inc.php?action=create',
          updateAction: 'process/storeskeepers.inc.php?action=update',
          deleteAction: 'process/storeskeepers.inc.php?action=delete'
        },
