 ...
 <script type="text/javascript">
    ...
    $(document).ready(function () {
      ...
      $('#PeopleTableContainer').jtable({
        ...
        actions: {
          listAction: 'process/directors.inc.php?action=list',
          createAction: 'process/directors.inc.php?action=create',
          updateAction: 'process/directors.inc.php?action=update',
          deleteAction: 'process/directors.inc.php?action=delete'
        },
